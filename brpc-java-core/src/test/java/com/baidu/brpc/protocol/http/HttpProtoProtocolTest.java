...
public class HttpProtoProtocolTest {
  ...
  private HttpRpcProtocol protocol = new HttpRpcProtocol(ProtocolType.PROTOCOL_HTTP_PROTOBUF_VALUE,
      "utf-8");
  ...
  public void testDecodeHttpRequest() throws Exception {
    ...
    ByteBuf content = Unpooled
        .wrappedBuffer(encodeBody(Echo.EchoRequest.newBuilder().setMessage("hello").build()));
