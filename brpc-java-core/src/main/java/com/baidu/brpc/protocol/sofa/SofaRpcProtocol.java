 ...
 * [<code>body_size(64)</code>][<code>message_size(64)</code>], 24 bytes in total
 * </li>
...
public class SofaRpcProtocol extends AbstractProtocol {
  ...
  @Override
  public SofaRpcDecodePacket decode(ChannelHandlerContext ctx, DynamicCompositeByteBuf in,
  ...
  public ByteBuf encodeResponse(Request request, Response response) throws Exception {
    ...
    if (response.getException() != null) {
      ...
      Compress compress = compressManager.getCompress(compressType);
      ByteBuf responseProtoBuf = compress
          .compressOutput(responseBodyMessage, response.getRpcMethodInfo());
