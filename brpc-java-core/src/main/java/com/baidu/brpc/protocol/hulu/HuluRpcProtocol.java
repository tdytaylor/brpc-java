...
public class HuluRpcProtocol extends AbstractProtocol {
  ...
  public ByteBuf encodeRequest(Request request) throws Exception {
    ...
    HuluRpcProto.HuluRpcRequestMeta.Builder metaBuilder = HuluRpcProto.HuluRpcRequestMeta
        .newBuilder();
  ...
  public Response decodeResponse(Object packet, ChannelHandlerContext ctx) throws Exception {
    ...
    try {
      ...
      HuluRpcProto.HuluRpcResponseMeta responseMeta = (HuluRpcProto.HuluRpcResponseMeta) ProtobufUtils
          .parseFrom(
  ...
  public Request decodeRequest(Object packet) throws Exception {
    ...
    ByteBuf protoBuf = null;
    try {
      HuluRpcProto.HuluRpcRequestMeta requestMeta = (HuluRpcProto.HuluRpcRequestMeta) ProtobufUtils
          .parseFrom(
  ...
  public ByteBuf encodeResponse(Request request, Response response) throws Exception {
    ...
    HuluRpcProto.HuluRpcResponseMeta.Builder metaBuilder = HuluRpcProto.HuluRpcResponseMeta
        .newBuilder();
  ...
  @Override
  public HuluRpcDecodePacket decode(ChannelHandlerContext ctx, DynamicCompositeByteBuf in,
