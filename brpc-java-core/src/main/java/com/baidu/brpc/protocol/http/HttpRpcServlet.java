...
/**
 * 在paas场景下部署时，bns会绑定到主端口上。 如果以servlet方式提供baidu json rpc协议的服务， client端就可以通过bns访问http服务。
 */
public class HttpRpcServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (errorMsg == null) {
      byte[] content = ((HttpRpcProtocol) protocol)
          .encodeResponseBody(protocolType, request, response);
