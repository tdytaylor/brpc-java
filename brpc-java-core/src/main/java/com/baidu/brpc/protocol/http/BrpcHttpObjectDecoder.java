...
public class BrpcHttpObjectDecoder extends HttpObjectDecoder {
  ...
  protected HttpMessage createInvalidMessage() {
    return isDecodingRequest() ?
        new DefaultFullHttpRequest(HttpVersion.HTTP_1_0, HttpMethod.GET, "/bad-request",
            validateHeaders) :
   ...
   *
   * @return DefaultHttpRequest or DefaultHttpResponse instance if success. If there's not enough
   * bytes, method will return null
   */
