...
public class BaiduRpcProtocol extends AbstractProtocol {
  ...
  private static final BaiduRpcProto.RpcMeta defaultRpcMetaInstance = BaiduRpcProto.RpcMeta
      .getDefaultInstance();
  ...
  @Override
  public BaiduRpcDecodePacket decode(ChannelHandlerContext ctx, DynamicCompositeByteBuf in,
  ...
  public ByteBuf encodeResponse(Request request, Response response) throws Exception {
    ...
    BaiduRpcProto.RpcResponseMeta.Builder responseMetaBuilder = BaiduRpcProto.RpcResponseMeta
        .newBuilder();
