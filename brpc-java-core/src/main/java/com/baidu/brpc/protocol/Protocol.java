...
/**
 * rpc协议接口，业务如果想实现一个自定义协议，需要实现该接口。 Created by huwenwei on 2017/9/22.
 */
public interface Protocol {
  ...
  /**
   * get a reusable request instance from threadLocal or pool the request instance must be reset
   * before reuse
   */
  Request getRequest();

  /**
   * get a reusable response instance from threadLocal or pool the response instance must be reset
   * before reuse
   */
