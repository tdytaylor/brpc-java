...
/**
 * Since {@linkplain java.util.concurrent.ExecutorService ExecutorService} is a bit slow, we have to
 * invent some wheels here.
 * <p>
 * NOT implement the {@linkplain java.util.concurrent.Executor Executor} interface unless we see the
 * necessity
 *
