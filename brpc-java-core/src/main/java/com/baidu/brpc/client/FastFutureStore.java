...
/**
 * A lock-free datastructure faster than #{@link java.util.concurrent.ConcurrentHashMap} in certain
 * circumstance. When the underlying array runs out of space, FastFutureStore will downgrade to
...
public class FastFutureStore {
  ...
  /**
   * The boundary between array-stored id and map-stored id. Binary format: 0100 0000 0000 0000 ...
   * ... 0000(64 bits).
   *
   * Ids less than(01xx xxxx ... xxx) this value should be stored in array. Ids greater than(01xx
   * xxxx ... xxx) this value should be stored in map.
   */
