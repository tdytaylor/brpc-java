...
/**
 * BrpcPooledChannelGroup class keeps fixed connections with one server Created by wenweihu86 on
 * 2017/9/29.
 */
...
public class BrpcPooledChannel extends AbstractBrpcChannel {
  ...
  /**
   * Used to save the rpc latency of the recent several rpc calls. This is for the fair load balance
   * algorithm.
   */
