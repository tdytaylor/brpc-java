...
public class ServerStatus {
  ...
  public String toString() {
    ...
    ret.append("Queue capacity:").append(threadPoolInfo.getDefaultQueueCapacity())
        .append(LINE_BREAK);
    ret.append("Producer queue size:").append(threadPoolInfo.getProducerQueueSize())
        .append(LINE_BREAK);
    ret.append("Consumer queue size:").append(threadPoolInfo.getConsumerQueueSize())
        .append(LINE_BREAK);
    ret.append(LINE_BREAK).append(LINE_BREAK);

    ret.append(PRE_STARTS);
    ret.append("--------------properties info(")
        .append(RpcServerOptions.class.getDeclaredFields().length)
    ...
    ret.append("--------------RPC service list(").append(serviceMap.size())
        .append(") ----------------")
        .append(LINE_BREAK);
  ...
  private String getOnlineDuration(long startTime) {
    ...
    ret.append(days).append(" days ").append(hours).append(" hours ").append(seconds)
        .append(" seconds");
