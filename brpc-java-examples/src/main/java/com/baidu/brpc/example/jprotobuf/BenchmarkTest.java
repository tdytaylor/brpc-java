...
//        options.setWorkThreadNum(2);
    ...
    EchoServiceControllerAsync echoService = BrpcProxy
        .getProxy(rpcClient, EchoServiceControllerAsync.class);
  ...
  public static class ThreadTask implements Runnable {
    ...
    EchoServiceControllerAsync echoService;
    private RpcClient rpcClient;
    private byte[] messageBytes;
    private SendInfo sendInfo;

    public ThreadTask(RpcClient rpcClient, EchoServiceControllerAsync echoService,
