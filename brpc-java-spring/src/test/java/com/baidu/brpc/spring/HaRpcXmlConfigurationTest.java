...
public class HaRpcXmlConfigurationTest extends RpcXmlConfigurationTestBase {
  ...
  public void setUp() {
    super.setUp();
    rpcServiceExporter1 = context
        .getBean("rpcServer1", RpcServiceExporter.class);
    rpcServiceExporter2 = context
        .getBean("rpcServer2", RpcServiceExporter.class);
    rpcServiceExporter3 = context
        .getBean("rpcServer3", RpcServiceExporter.class);
  }
